    ...
    $.widget( "livestreet.lsMedia", $.livestreet.lsComponent, {
        ...
        options: {
            ...
            uploader_options: {
                urls: {
                    // Подгрузка файлов
                    load: aRouter['ajax'] + 'media/load-gallery-old/'
                },
                params:{
                    target_type:"user"
                }
        ...
        _create: function () {
            ...
            this.option( 'uploader_options.params.target_type',  )
            ...
            this.elements.uploader.lsUploader( $.extend( {}, this.option( 'uploader_options' ), {
                ...
                params: {
                    ...
                    target_type:this.element.data( 'targetType' ),
                    target_id:this.element.data( 'targetId' )
                },
