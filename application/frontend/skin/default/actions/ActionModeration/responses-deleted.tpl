...
{block 'layout_page_title'}
    <h2 class="page-header">{lang 'moderation.responses_deleted.title'}</h2>
{/block}
        ...
        <div class="col-sm-8">
            <form action="{router page="moderation/responses-all"}" class="form-inline">
                ...
                <div class="d-flex m-1"> 
                    ...
                    {component "button"  classes="d-inline-block ml-2" bmods="primary" type="submit" text=$aLang.moderation.responses_all.form.submit}
                </div>
